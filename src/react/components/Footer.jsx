						...
						<li className="nav__item">
							<a target="_blank" rel="noreferrer" aria-label="author's website"
							   href="https://martinkamir.com/">
								<svg className="footer__link-icon" width="28" height="28" viewBox="0 0 100 66"
									...
									<path d="M61.65,58.98L61.65,58.98c-11.43,6.6-26.04,2.68-32.64-8.75L4.11,7.09C3.78,6.53,3.97,5.81,4.54,5.48l0,0
 c11.43-6.6,26.04-2.68,32.64,8.75l24.91,43.14C62.41,57.93,62.22,58.65,61.65,58.98z"></path>
									<path d="M97.98,58.98L97.98,58.98c-11.43,6.6-26.04,2.68-32.64-8.75L40.43,7.09c-0.33-0.56-0.13-1.28,0.43-1.61l0,0
 C52.29-1.12,66.9,2.8,73.5,14.23l24.91,43.14C98.74,57.93,98.54,58.65,97.98,58.98z"></path>
									<g></g>
								</svg>
							</a>
						</li>
