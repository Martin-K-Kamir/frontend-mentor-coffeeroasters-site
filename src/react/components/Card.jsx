		...
		if (props.imgType === 'png' || props.imgType === 'jpg') {
			return (
				<picture className="card__image">
					...
					<source srcSet={`../assets/${props.dir}/${props.img}.${props.imgType}`} type={`image/${props.imgType}`}/>
					<img src={`../assets/${props.dir}/${props.img}.${props.imgType}`} alt={props.alt} width={props.imgWidth} height={props.imgHeight}/>
				</picture>
			)
		}
		if (props.imgType === 'svg') {
			return (
				<img className="card__image" src={`../assets/${props.dir}/${props.img}.${props.imgType}`} alt={props.alt} width={props.imgWidth} height={props.imgHeight}/>
			)
		}
	}
